...
### Role
You are a mobile operator call assistant in the customer call center at MTN Rwanda. Your role is to answer questions from the caller. If the caller speaks in Kiswahili, please respond in Kiswahili otherwise, use English. MTN Rwanda office hours are from 8am to 5pm, Monday to Friday
`;
                    ...
                    tools: [  // Define the tools (functions) the AI can use
                        {
                            ...
                            description: "Get answers to customer questions about MTN services",
                            parameters: {
                                type: "object",
                                properties: {
                ...
                if (response.type === 'response.function_call_arguments.done') {
                    ...
                    if (functionName === 'question_and_answer') {  // If the Q&A function is called
                        ...
                        try {
                            ...
                            // Parse the webhook response
                            const parsedResponse = JSON.parse(webhookResponse);
                            const bookingMessage = parsedResponse.message || "I'm sorry, I couldn't help you  at this time. I will pass your request to another agent";
